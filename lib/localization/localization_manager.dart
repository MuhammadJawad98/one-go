...
class AppLocalization {
  ...
  Future<void> load() async {
    String jsonStringValues = await rootBundle.loadString("lib/localization/languageFiles/${locale.languageCode}.json");
...
class _DemoLocalizationsDelegate extends LocalizationsDelegate<AppLocalization> {
  ...
  bool isSupported(Locale locale) {
    ...
    for (var language in DataManager().languageList) {
